...
SAVE_DIRECTORY = config['TRAINING']['weights_directory']
    ...
    for epoch in range(n_epochs):
        ...
        if val_loss / len(val_loader) <= best_loss:
            ...
            torch.save({
                ...
                f'{SAVE_DIRECTORY}/{start_time}/best_{encoder_name}.pt'
            )
        ...
        if (epoch + 1) % 5 == 0:
            torch.save({
                ...
                f'{SAVE_DIRECTORY}/{start_time}/{encoder_name}_{epoch + 1}.pt'
            )
