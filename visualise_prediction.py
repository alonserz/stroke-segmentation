...
# Настройки
DATASET_PATH = "./data/test_dataset.h5"
MODEL = './best_loss_model.pt'
BATCH_SIZE = 1  # Обрабатываем по одному изображению для удобства визуализации
...
def main():
    ...
    checkpoint = torch.load(r"D:\projects\stroke-segmentation\models_weights\1755183012.4822984\best_efficientnet-b2.pt", map_location=DEVICE)
